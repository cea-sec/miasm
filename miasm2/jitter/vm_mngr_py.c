...
PyObject *_vm_get_exception(unsigned int xcpt)
{
	...
	if (!xcpt)
		...
		p = PyErr_Format(PyExc_RuntimeError, "EXCEPT_UNKNOWN");
	return p;
}
...
PyObject *vm_get_exception(VmMngr *self, PyObject *args)
{
	return PyLong_FromUnsignedLongLong(
	    (uint64_t)self->vm_mngr.exception_flags);
}
...
static PyObject *vm_set_little_endian(VmMngr *self, PyObject *value,
				      void *closure)
{
...
{
	return PyLong_FromUnsignedLongLong((uint64_t)(intptr_t) &
					   (self->vm_mngr));
}
...
static PyMethodDef VmMngr_methods[] = {
    {"init_memory_page_pool", (PyCFunction)vm_init_memory_page_pool,
     METH_VARARGS, "X"},
    {"init_memory_breakpoint", (PyCFunction)vm_init_memory_breakpoint,
     METH_VARARGS, "X"},
    {"init_code_bloc_pool", (PyCFunction)vm_init_code_bloc_pool, METH_VARARGS,
     "X"},
    {"set_mem_access", (PyCFunction)vm_set_mem_access, METH_VARARGS, "X"},
    {"set_mem", (PyCFunction)vm_set_mem, METH_VARARGS, "X"},
    {"set_addr2obj", (PyCFunction)vm_set_addr2obj, METH_VARARGS, "X"},
    {"add_code_bloc", (PyCFunction)vm_add_code_bloc, METH_VARARGS, "X"},
    {"get_mem", (PyCFunction)vm_get_mem, METH_VARARGS, "X"},
    {"add_memory_page", (PyCFunction)vm_add_memory_page, METH_VARARGS, "X"},
    {"add_memory_breakpoint", (PyCFunction)vm_add_memory_breakpoint,
     METH_VARARGS, "X"},
    {"remove_memory_breakpoint", (PyCFunction)vm_remove_memory_breakpoint,
     METH_VARARGS, "X"},
    {"set_exception", (PyCFunction)vm_set_exception, METH_VARARGS, "X"},
    {"dump_memory_breakpoint", (PyCFunction)vm_dump_memory_breakpoint,
     METH_VARARGS, "X"},
    {"get_all_memory", (PyCFunction)vm_get_all_memory, METH_VARARGS, "X"},
    {"reset_memory_page_pool", (PyCFunction)vm_reset_memory_page_pool,
     METH_VARARGS, "X"},
    {"reset_memory_breakpoint", (PyCFunction)vm_reset_memory_breakpoint,
     METH_VARARGS, "X"},
    {"reset_code_bloc_pool", (PyCFunction)vm_reset_code_bloc_pool, METH_VARARGS,
     "X"},
    {"set_alarm", (PyCFunction)set_alarm, METH_VARARGS, "X"},
    {"get_exception", (PyCFunction)vm_get_exception, METH_VARARGS, "X"},
    {"get_exception", (PyCFunction)vm_get_exception, METH_VARARGS, "X"},

    {"set_big_endian", (PyCFunction)vm_set_big_endian, METH_VARARGS, "X"},
    {"set_little_endian", (PyCFunction)vm_set_little_endian, METH_VARARGS, "X"},
...
static PyGetSetDef VmMngr_getseters[] = {
    {"vmmngr", (getter)VmMngr_get_vmmngr, (setter)VmMngr_set_vmmngr,
     "first name", NULL},
    {NULL} /* Sentinel */
};
