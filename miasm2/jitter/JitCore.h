...
#define getset_reg_u64(regname)                                                \
	...
	{                                                                      \
		return PyLong_FromUnsignedLongLong(                            \
		    (uint64_t)(((vm_cpu_t *)(self->cpu))->regname));           \
	}                                                                      \
...
#define getset_reg_u32(regname)                                                \
	...
	{                                                                      \
		return PyLong_FromUnsignedLongLong(                            \
		    (uint32_t)(((vm_cpu_t *)(self->cpu))->regname));           \
	}                                                                      \
	static int JitCpu_set_##regname(JitCpu *self, PyObject *value,         \
					void *closure)                         \
	{                                                                      \
...
#define getset_reg_u16(regname)                                                \
	...
	{                                                                      \
		return PyLong_FromUnsignedLongLong(                            \
		    (uint16_t)(((vm_cpu_t *)(self->cpu))->regname));           \
	}                                                                      \
	static int JitCpu_set_##regname(JitCpu *self, PyObject *value,         \
					void *closure)                         \
	{                                                                      \
...
#define get_reg(reg)                                                           \
	do {                                                                   \
		o = PyLong_FromUnsignedLongLong(                               \
		    (uint64_t)((vm_cpu_t *)(self->cpu))->reg);                 \
...
#define get_reg_off(reg)                                                       \
	do {                                                                   \
		o = PyLong_FromUnsignedLongLong(                               \
		    (uint64_t)offsetof(vm_cpu_t, reg));                        \
		PyDict_SetItemString(dict, #reg, o);                           \
		Py_DECREF(o);                                                  \
	} while (0);
