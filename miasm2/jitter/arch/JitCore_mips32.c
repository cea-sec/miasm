...
reg_dict gpreg_dict[] = {
    {.name = "ZERO", .offset = offsetof(vm_cpu_t, ZERO)},
...
void dump_gpregs(vm_cpu_t *vmcpu)
{
	...
	printf("ZR %.8" PRIX32 " AT %.8" PRIX32 " V0 %.8" PRIX32
	       " V1 %.8" PRIX32 " ",
	       vmcpu->ZERO, vmcpu->AT, vmcpu->V0, vmcpu->V1);
	printf("A0 %.8" PRIX32 " A1 %.8" PRIX32 " A2 %.8" PRIX32
	       " A3 %.8" PRIX32 " ",
	       vmcpu->A0, vmcpu->A1, vmcpu->A2, vmcpu->A3);
	printf("T0 %.8" PRIX32 " T1 %.8" PRIX32 " T2 %.8" PRIX32
	       " T3 %.8" PRIX32 " ",
	       vmcpu->T0, vmcpu->T1, vmcpu->T2, vmcpu->T3);
	printf("T4 %.8" PRIX32 " T5 %.8" PRIX32 " T6 %.8" PRIX32
	       " T7 %.8" PRIX32 "\n",
	       vmcpu->T4, vmcpu->T5, vmcpu->T6, vmcpu->T7);
	printf("S0 %.8" PRIX32 " S1 %.8" PRIX32 " S2 %.8" PRIX32
	       " S3 %.8" PRIX32 " ",
	       vmcpu->S0, vmcpu->S1, vmcpu->S2, vmcpu->S3);
	printf("S4 %.8" PRIX32 " S5 %.8" PRIX32 " S6 %.8" PRIX32
	       " S7 %.8" PRIX32 " ",
	       vmcpu->S4, vmcpu->S5, vmcpu->S6, vmcpu->S7);
	printf("T8 %.8" PRIX32 " T9 %.8" PRIX32 " K0 %.8" PRIX32
	       " K1 %.8" PRIX32 " ",
	       vmcpu->T8, vmcpu->T9, vmcpu->K0, vmcpu->K1);
	printf("GP %.8" PRIX32 " SP %.8" PRIX32 " FP %.8" PRIX32
	       " RA %.8" PRIX32 "\n",
...
static PyGetSetDef JitCpu_getseters[] = {
    ...
    {"PC_FETCH", (getter)JitCpu_get_PC_FETCH, (setter)JitCpu_set_PC_FETCH,
     "PC_FETCH", NULL},
...
PyMODINIT_FUNC initJitCore_mips32(void)
{
	...
	JitCore_mips32_Error =
	    PyErr_NewException("JitCore_mips32.error", NULL, NULL);
