...
void dump_gpregs(vm_cpu_t *vmcpu)
{
	...
	printf("R4  %.4" PRIX32 " R5  %.4" PRIX32 " R6  %.4" PRIX32
	       " R7  %.4" PRIX32 "\n",
	       vmcpu->R4, vmcpu->R5, vmcpu->R6, vmcpu->R7);
	printf("R8  %.4" PRIX32 " R9  %.4" PRIX32 " R10 %.4" PRIX32
	       " R11 %.4" PRIX32 " ",
	       vmcpu->R8, vmcpu->R9, vmcpu->R10, vmcpu->R11);
	printf("R12 %.4" PRIX32 " R13 %.4" PRIX32 " R14 %.4" PRIX32
	       " R15 %.4" PRIX32 "\n",
	       vmcpu->R12, vmcpu->R13, vmcpu->R14, vmcpu->R15);
	printf("zf %.4" PRIX32 " nf %.4" PRIX32 " of %.4" PRIX32
	       " cf %.4" PRIX32 "\n",
...
static PyGetSetDef JitCpu_getseters[] = {
    ...
    {"cpuoff", (getter)JitCpu_get_cpuoff, (setter)JitCpu_set_cpuoff, "cpuoff",
     NULL},
...
PyMODINIT_FUNC initJitCore_msp430(void)
{
	...
	JitCore_msp430_Error =
	    PyErr_NewException("JitCore_msp430.error", NULL, NULL);
